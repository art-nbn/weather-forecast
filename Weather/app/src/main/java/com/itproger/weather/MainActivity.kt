    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        main_btn?.setOnClickListener {
            if(user_field?.text?.toString()?.trim()?.equals("")!!)
                ...
                val key: String = "92f2bce00816726d3cfc2c84f13b3447"
                val url: String = "https://api.openweathermap.org/data/2.5/weather?q=$city&appid=92f2bce00816726d3cfc2c84f13b3447&units=metric&lang=ru"
